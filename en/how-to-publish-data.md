...
2. Click on **Collections** on the left side of the window.
    ...
    2.1. If you want to update an existing collection, go directly to point 4.
    2.2. If you want to create a new collection that is not yet on this page, go to the next step.
3. Click on **New collection** on the right side of the window.
    3.1. Select the type of your data (Available types: Zoology, Botany, Geology, Paleontology). ⚠️**Mandatory**⚠️
    3.2. Select the corresponding GrSciColl Collection of your institution. ⚠️**Mandatory**⚠️
    ...
    3.3. Add a description of the collection. 💡optional💡
    3.4. Click on **Create collection**
...
4. Click on the collection name.
   ...
   4.1. If your collection is empty, click either on the **+ Import** button in the center of the page, or the **Import dataset** button in the top-right corner.
   4.2. If your collection already has record and you want to add new records or update them, click on the **Import dataset** button in the top-right corner.
...
6. Select in the drop-down menu **Filter columns...** the corresponding field in your imported file of each required attributes.
   ...
   6.1. Either click on **+ Add all** or on the attribute names (with grey background) to map your fields with the additional attributes.
      - The added attributes appear at the bottom of the Mappings window.
   6.2. Repeat these steps until all of the fields you want to map are mapped.
    ...
    6.3. When satisfied with your mapping, click on **Update mapping**
       ...
       6.3.1. When satisfied, click on **Run import**.
