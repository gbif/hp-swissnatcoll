...
3. **Select the data layer** allows you to determine which data values you want to export. You can choose between:
    ...
    - the validated data (Validated), which corresponds to the data received from the InfoSpecies data centers after requesting a validation in the [Validate my data](#validate-my-data) part. ⚠️The validated data can only be obtained in combination with the DWC Attributes headers selection.
