...
| 3 | [country](https://dwc.tdwg.org/terms/#dwc:country){:target='_blank'} | The name of the country or major administrative unit in which the Location occurs.| Pays<br> Land | ... |
...
| 3 | [locality](https://dwc.tdwg.org/terms/#dwc:locality){:target='_blank'} | The specific description of the place. | Lieu<br> Fundort | ... |
...
| 3 | _yearCollectionEntrance_ | The four-digit year of collection entrance of a specimen (earliest year of occurrence in absence of a documented collection event). | ... |
...
| 4 | _lastVerifiedBy_ | Person confirming the identification (usually a specialist of the corresponding systematic family). |  |
...
| 4 | _completeness_ | Degree of completeness of the specimen; may describe completeness of a part. <br> e.g. complete, cephalon only, complete skull |  |
