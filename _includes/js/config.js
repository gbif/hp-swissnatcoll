...
var siteConfig = {
  ...
  routes: {
    enabledRoutes: ['occurrenceSearch', 'occurrenceKey', 'publisherSearch', 'publisherKey', 'datasetsSearch', 'datasetsKey', 'literatureSearch', 'litteratureKey', 
    ...
    rootPredicate: {
      ...
      "predicates": [
        ...
        },
        {
          "type": "equals",
          "key": "networkKey",
          "value": "0b00b924-016b-4954-96a7-2d9264b5d0ba" //Datanetwork=SwissBIF(swissbif.ch)
        },
        {
          "type": "equals",
            "key": "basisOfRecord",
