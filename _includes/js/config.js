...
var siteConfig = {
  ...
  version: 2,
  availableCatalogues: ['OCCURRENCE', 'DATASET', 'INSTITUTION', 'LITERATURE'],
  routes: {
    enabledRoutes: ['occurrenceSearch', 'institutionSearch', 'institutionKey', 'datasetKey', 'datasetSearch', 'literatureSearch'],
  },
  occurrence: {
    mapSettings: {
      enabled: true,
